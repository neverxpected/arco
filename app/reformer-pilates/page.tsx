      ...
      <nav className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <a href="/" className="text-xl font-black tracking-tight">
            ...
            <span className="text-[#007CAF]">FIT</span>
          </a>
          <div className="hidden md:flex items-center gap-6 text-xs font-medium tracking-widest uppercase text-white/70">
            ...
            <div className="relative group">
              <a href="/group-fitness" className="hover:text-[#007CAF] transition-colors flex items-center gap-1">
                Group Fitness
              ...
              <div className="absolute top-full left-0 mt-2 w-48 bg-black/95 backdrop-blur-md border border-slate-200 rounded-lg py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 translate-y-1 group-hover:translate-y-0">
                ...
                <a href="/reformer-pilates" className="block px-4 py-2 text-[#007CAF] hover:bg-slate-100 transition-colors normal-case tracking-normal text-xs">Reformer Pilates</a>
          ...
          <a href="tel:3465532726" className="bg-[#007CAF] hover:brightness-110 text-white text-xs font-bold px-4 py-2 rounded transition-colors tracking-wider">
            346-553-ARCO
          </a>
        </div>
      </nav>
