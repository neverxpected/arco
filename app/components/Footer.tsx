      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/40">
            <li><a href="/" className="hover:text-[#0096C7] transition-colors">Home</a></li>
            <li><a href="/group-fitness" className="hover:text-[#0096C7] transition-colors">Group Fitness</a></li>
            <li><a href="/reformer-pilates" className="hover:text-[#0096C7] transition-colors">Reformer Pilates</a></li>
            <li><a href="/amenities" className="hover:text-[#0096C7] transition-colors">Amenities</a></li>
            <li><a href="https://arcofitgym.clubautomation.com/member-portal/locations/1/memberships" target="_blank" rel="noopener noreferrer" className="hover:text-[#0096C7] transition-colors">Membership Options</a></li>
            <li><a href="/about-us" className="hover:text-[#0096C7] transition-colors">About Us</a></li>
            <li><a href="/events" className="hover:text-[#0096C7] transition-colors">Events</a></li>
        ...
        <div>
          ...
          <div className="flex gap-3">
            <a href="https://www.facebook.com/profile.php?id=100093109776783" target="_blank" rel="noopener noreferrer" className="w-9 h-9 border border-white/20 rounded-lg flex items-center justify-center hover:border-[#0096C7] hover:text-[#0096C7] transition-colors text-white/70">
