...
export default function AboutPage() {
  ...
  return (
    <main className="bg-white text-slate-900">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-black uppercase leading-none mb-6 opacity-0 animate-[fadeUp_0.8s_ease_0.4s_forwards]">
            Our <span className="text-[#007CAF]">Story</span>
          </h1>
      ...
      <section className="pb-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="reveal opacity-0 translate-y-8 transition-all duration-700 text-center mb-12">
            <p className="text-[#007CAF] text-xs font-bold tracking-[0.3em] uppercase mb-3">The Beginning</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
            {founders.map((founder, i) => (
              ...
              >
                <div className="w-full aspect-square bg-slate-100 rounded-xl border border-slate-200 overflow-hidden transition-all duration-500 group-hover:border-[#007CAF]/60 group-hover:shadow-[0_0_25px_rgba(0,124,175,0.2)] group-hover:-translate-y-2 group-hover:scale-[1.02]">
                  <img
                    src={founder.image}
                    alt={founder.name}
                ...
                <h3 className="font-bold text-sm sm:text-base uppercase tracking-wider mt-4 transition-colors duration-300 group-hover:text-[#007CAF]">
                  {founder.name}
                </h3>
                <p className="text-slate-400 text-xs mt-1">Founder</p>
              </div>
            ))}
          </div>
          ...
          <div className="reveal opacity-0 translate-y-8 transition-all duration-700 max-w-4xl mx-auto">
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 sm:p-12">
              <div className="w-12 h-1 bg-[#007CAF] mb-6 mx-auto sm:mx-0 rounded" />
      ...
      <section className="bg-slate-50 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="reveal opacity-0 translate-y-8 transition-all duration-700 text-center mb-14">
            <p className="text-[#007CAF] text-xs font-bold tracking-[0.3em] uppercase mb-3">What We Stand For</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((val, i) => (
              ...
              >
                <div className="h-full bg-white border border-slate-200 rounded-xl p-6 text-center transition-all duration-500 hover:border-[#007CAF]/40 hover:shadow-[0_0_20px_rgba(0,124,175,0.1)] hover:-translate-y-1">
                  <div className="text-[#007CAF] flex justify-center mb-4">
                    {val.icon}
                  </div>
                  <h3 className="font-bold text-sm uppercase tracking-wider mb-3 group-hover:text-[#007CAF] transition-colors duration-300">{val.title}</h3>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="reveal opacity-0 translate-y-8 transition-all duration-700 max-w-4xl mx-auto text-center">
            <p className="text-[#007CAF] text-xs font-bold tracking-[0.3em] uppercase mb-3">Our Purpose</p>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 sm:p-12 relative overflow-hidden">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-[#007CAF]/30 mx-auto mb-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            >
              ...
              <p className="text-white/50 text-xs sm:text-sm uppercase tracking-widest font-medium">{stat.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* CTA */}
      <section className="reveal opacity-0 translate-y-8 transition-all duration-700 bg-slate-950 py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-black uppercase mb-4 text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="https://arcofitgym.clubautomation.com/member-portal/locations/1/memberships" target="_blank" rel="noopener noreferrer" className="bg-[#007CAF] hover:brightness-110 text-white font-bold px-8 py-3 rounded transition-all hover:scale-105 tracking-wider uppercase text-xs">
              Membership Options
            </a>
