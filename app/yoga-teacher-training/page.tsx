    ...
    <main className="bg-black text-white">
          ...
          <div className="hidden md:flex items-center gap-6 text-xs font-medium tracking-widest uppercase text-white/70">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-48 bg-black/95 backdrop-blur-md border border-white/10 rounded-lg py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 translate-y-1 group-hover:translate-y-0">
                ...
                <a href="/yoga-teacher-training" className="block px-4 py-2 text-[#0096C7] hover:bg-white/5 transition-colors normal-case tracking-normal text-xs">Yoga Teacher Training</a>
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          <p className="text-[#0096C7] text-xs font-bold tracking-[0.3em] uppercase mb-4 opacity-0 animate-[fadeUp_0.8s_ease_0.2s_forwards]">200-Hour Certification</p>
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-black uppercase leading-none mb-6 opacity-0 animate-[fadeUp_0.8s_ease_0.4s_forwards]">
            Yoga Teacher <span className="text-[#0096C7]">Training</span>
          </h1>
          ...
          <a href="https://arcofitgym.clubautomation.com/calendar/event-info?id=10661" target="_blank" rel="noopener noreferrer" className="bg-[#0096C7] hover:bg-[#0077A8] text-white font-bold px-8 py-3 rounded transition-all hover:scale-105 tracking-wider uppercase text-xs inline-block opacity-0 animate-[fadeUp_0.8s_ease_0.8s_forwards]">
            Register Now
          </a>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="reveal opacity-0 translate-y-8 transition-all duration-700 text-center mb-14">
            <p className="text-[#0096C7] text-xs font-bold tracking-[0.3em] uppercase mb-3">What You&apos;ll Learn</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {curriculum.map((item, i) => (
              <div key={i} className="reveal opacity-0 translate-y-8 transition-all duration-700 group" style={{ transitionDelay: `${(i % 6) * 80}ms` }}>
                <div className="h-full border border-gray-200 rounded-xl overflow-hidden flex flex-col transition-all duration-500 hover:border-[#0096C7]/60 hover:shadow-[0_0_25px_rgba(0,150,199,0.15)] hover:-translate-y-1">
                  {/* Dark Top */}
                  <div className="bg-[#111111] p-5">
                    <div className="flex items-center gap-3">
                      <span className="text-2xl">{item.icon}</span>
                      <h3 className="text-white font-bold text-sm uppercase tracking-wider group-hover:text-[#0096C7] transition-colors duration-300">{item.title}</h3>
                    </div>
                  </div>
                  {/* Light Bottom */}
      ...
      <section className="bg-[#0A0A0A] py-20 px-4 border-y border-white/10">
        <div className="max-w-7xl mx-auto">
          <div className="reveal opacity-0 translate-y-8 transition-all duration-700 text-center mb-14">
            <p className="text-[#0096C7] text-xs font-bold tracking-[0.3em] uppercase mb-3">Your Guides</p>
            <h2 className="text-3xl sm:text-4xl font-black uppercase">About Your <span className="text-[#0096C7]">Teachers</span></h2>
          </div>
            ...
            {[
              ...
              <div key={i} className="reveal opacity-0 translate-y-8 transition-all duration-700" style={{ transitionDelay: `${i * 150}ms` }}>
                <div className="bg-white border border-gray-200 rounded-xl p-8">
                  ...
                  <p className="text-[#0096C7] text-xs font-bold tracking-wider mb-4">{t.creds}</p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="reveal opacity-0 translate-y-8 transition-all duration-700 text-center mb-14">
            <p className="text-[#0096C7] text-xs font-bold tracking-[0.3em] uppercase mb-3">Details</p>
            <h2 className="text-3xl sm:text-4xl font-black uppercase">Dates, Schedule & <span className="text-[#0096C7]">Cost</span></h2>
          </div>
          <div className="reveal opacity-0 translate-y-8 transition-all duration-700 grid sm:grid-cols-2 gap-6">
            <div className="bg-white border border-gray-200 rounded-xl p-8">
              <h3 className="font-bold text-sm uppercase tracking-wider text-[#0096C7] mb-4">Schedule</h3>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-8">
              <h3 className="font-bold text-sm uppercase tracking-wider text-[#0096C7] mb-4">Pricing</h3>
              <ul className="space-y-2 text-gray-600 text-sm">
                ...
                <li className="flex justify-between"><span>Early bird discount</span><span className="text-[#0096C7]">−$100</span></li>
                <li className="flex justify-between"><span>Paid in full discount</span><span className="text-[#0096C7]">−$200</span></li>
              </ul>
      ...
      <section className="bg-[#0A0A0A] py-16 px-4 border-y border-white/10">
        <div className="max-w-4xl mx-auto">
          <div className="reveal opacity-0 translate-y-8 transition-all duration-700">
            <h3 className="font-bold text-sm uppercase tracking-wider text-[#0096C7] mb-6 text-center">Required Reading</h3>
            ...
            <p className="text-white/30 text-xs text-center mt-4">Cost of books is not included in tuition.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center reveal opacity-0 translate-y-8 transition-all duration-700">
          <img src="https://arcofitgym.com/wp-content/uploads/2026/01/RYS200-300x300.png" alt="RYS 200 Certification" className="w-24 h-24 mx-auto mb-6 invert brightness-200" />
          <p className="text-white/60 text-sm leading-relaxed max-w-2xl mx-auto">After completing the 200-Hour Arco Fit Yoga Teacher Training program, you will be eligible to obtain your Registered Yoga Teacher 200-Hour Certificate (RYT-200) from Yoga Alliance.</p>
        </div>
      </section>
      ...
      <section className="reveal opacity-0 translate-y-8 transition-all duration-700 bg-[#0A0A0A] py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-black uppercase mb-4">Begin Your <span className="text-[#0096C7]">Journey</span></h2>
          <p className="text-white/50 text-sm sm:text-base mb-8 max-w-xl mx-auto">Step onto the mat. Step into your calling. For questions, reach out at Samantha.Walker@arcofitgym.com</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="https://arcofitgym.clubautomation.com/calendar/event-info?id=10661" target="_blank" rel="noopener noreferrer" className="bg-[#0096C7] hover:bg-[#0077A8] text-white font-bold px-8 py-3 rounded transition-all hover:scale-105 tracking-wider uppercase text-xs">Register Now</a>
